                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{action('CustomerTypeController@show', $customer_type->id)}}?show=discounts"
                                ...
                                $customer_type->total_product_discount + $customer_type->total_coupon_discount)}}</a>
                        </td>
                        @php
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    ...
                                    <li>
                                        ...
                                        <a href="{{action('CustomerTypeController@show', $customer_type->id)}}"
                                            class="btn"><i class="dripicons-document"></i> @lang('lang.view')</a>
                                    </li>
                                    <li class="divider"></li>
                                    @endcan
                    ...
                    @php
                    $total_discounts += $customer_type->total_sp_discount + $customer_type->total_product_discount +
