                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 hide">
                                        <div class="form-group">
                                            ...
                                            @format_date($expense->transaction_date) : @format_date(date('Y-m-d')),
                                    ...
                                    <div
                                        ...
                                        <div class="i-checks">
                                            <input id="notify_me" name="notify_me" type="checkbox" @if
                                                ($expense->notify_me) checked @endif value="1"
                                            class="form-control-custom">
                                            <label for="notify_me"><strong>@lang('lang.notify_me')</strong></label>
                                        </div>
                                    </div>
                                    <div
                                        class="col-md-4 notify_field @if (empty($expense->next_payment_date)) hide @endif">
                                        <div class="form-group">
