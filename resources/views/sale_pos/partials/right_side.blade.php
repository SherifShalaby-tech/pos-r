                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="card mt-1 mb-0 col-md-12 px-0">
                            <div class="card-body d-flex justify-content-between p-1">
                                ...
                                <div
                                    class=" px-0 toggle-pill-color-pos d-flex justify-content-center align-items-center flex-column">
                                    <input type="checkbox" class="selling_filter" id="best_selling"
                                        value="best_selling">
                                ...
                                <div
                                    class=" px-0 toggle-pill-color-pos d-flex justify-content-center align-items-center flex-column">
                                    <input type="checkbox" class="selling_filter" id="slow_moving_items"
                                        value="slow_moving_items">
                        ...
                        <div class="card mt-1 mb-0 col-md-12 px-0">
                            <div class="card-body d-flex justify-content-center p-1" style="gap: 70px">
                                ...
                                <div
                                    class=" px-0 toggle-pill-color-pos d-flex justify-content-center align-items-center flex-column">
                                    <input type="checkbox" class="price_filter" id="highest_price"
                                        value="highest_price">
                        ...
                        <div class="card mt-1 mb-0 col-md-12 px-0">
                            <div class="card-body d-flex justify-content-center p-1" style="gap: 20px">
                                ...
                                <div
                                    class=" px-0 toggle-pill-color-pos d-flex justify-content-center align-items-center flex-column">
                                    <input type="checkbox" class="expiry_filter" id="nearest_expiry"
                                ...
                                <div
                                    class=" px-0 toggle-pill-color-pos d-flex justify-content-center align-items-center flex-column">
                                    <input type="checkbox" class="expiry_filter" id="longest_expiry"
                                        value="longest_expiry">
                        ...
                        @endif
                        <div
                            class="card mt-1 mb-0 col-md-12 px-0 @if (session('system_mode') == 'restaurant') hide @endif">
                        ...
                        <div
                            ...
                            <div class="card-body d-flex justify-content-center p-1">
                                ...
                                <div
                                    class=" px-0 toggle-pill-color-pos d-flex justify-content-center align-items-center flex-column">
                                    <input type="checkbox" class="package_sale_promo_filter"
                                        id="package_in_sale_promotion" value="package_in_sale_promotion">
                            ...
                            <div class="btn-group btn-group-toggle ml-2 btn-group-custom" data-toggle="buttons">
                                <label class="btn btn-primary active filter-btn">
                                    <input type="radio" checked autocomplete="off" name="restaurant_filter"
                                        id="all_restaurant_filter" value="all">
                                    @lang('lang.all')
                                </label>
