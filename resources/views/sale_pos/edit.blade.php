                ...
                <div class="@if (session('system_mode') == 'pos') col-md-7 @else col-md-6 @endif">
                    ...
                    <div class="card">
                        <div class="card-body" style="padding: 0px 10px; !important">
                            ...
                            {{-- <input type="hidden" name="transaction_id" id="transaction_id" value="{{(!empty($transaction) && $transaction->id)?$transaction->id:0}}"> --}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('rt_created_by', $cashiers, false, ['class' => 'form-control filter_transactions selectpicker', 'id' => 'rt_created_by', 'data-live-search' => 'true', 'placeholder' => __('lang.all')]) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
