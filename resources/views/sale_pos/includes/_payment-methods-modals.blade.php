...
@php
$types = App\Models\PaymentMethodType::where('payment_method_id' , '=' , $method->id )->pluck('name');

@endphp
<div id="{{ $method->name }}" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
    class="modal fade text-left">
    <div role="document" class="modal-dialog" style="max-width: 90%!important">
        <div class="modal-content">
            <x-modal-header>

                <h5 id="exampleModalLabel" class="modal-title">{{ $method->name }}</h5>
                            ...
                            <div id="payment_rows" class="col-md-12">
                                <div class="payment_row row pl-3  pr-3">
                                    ...
                                    <div class="col-md-3 mt-1">
                                        ...
                                        {!! Form::select('payments[0][method]', $types, null, ['class' =>
