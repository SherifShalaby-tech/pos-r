                        ...
                        <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('supplier_id', $suppliers, array_key_first($suppliers), ['class' =>
                                    'selectpicker form-control', 'data-live-search' => 'true', 'required', 'style' =>
                                    'width: 80%', 'placeholder' => __('lang.please_select')]) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    'Partially Received', 'pending' => 'Pending'], 'received', ['class' => 'selectpicker
                        ...
                        <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                            ...
                            <div class="col-md-3 due_amount_div hide">
                                <label class="@if (app()->isLocale('ar')) mb-1 label-ar @else mb-1 label-en @endif"
                                    for="due_amount">@lang('lang.due'): <span class="due_amount_span">{{ @num_format(0)
                                        }}</span></label>
                            </div>
