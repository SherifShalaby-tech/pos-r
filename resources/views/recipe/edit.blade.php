                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group my-group">
                                    {!! Form::select('material_id', $raw_materials, !empty($recipe) ?
                                    $recipe->material_id: false, ['class' => 'select_material_id selectpicker
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group my-group">
                                        {!! Form::text('name', !empty($recipe) ? $recipe->name : null, ['class' =>
                                        'form-control', 'required', 'placeholder' => __('lang.name')]) !!}
                                        <span class="input-group-btn">
