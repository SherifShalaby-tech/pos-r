                        ...
                        <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('reasons_of_deductibles', null, ['class' => 'form-control', 'rows' =>
                                    3,
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('payment_date', @format_date(date('Y-m-d')), ['class' =>
                                    'form-control
                            ...
                            <div class="row mt-4">
                                <div class="col-sm-12">
                                    {{-- <input type="submit" class="btn btn-primary" value="@lang('lang.save')"
                                        name="submit">--}}
                                    <input type="submit" class="btn btn-primary" value="@lang('lang.paid')"
                                        name="submit">
                                </div>
                            </div>
