                        ...
                        <ul class="nav nav-tabs ml-4 mt-3" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if (request()->show == 'service_provided') active @endif"
                                    href="#service-provided" role="tab"
                                    data-toggle="tab">@lang('lang.service_provided')</a>
                            </li>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <b>@lang('lang.company_name'):</b> <span
                                                    class="customer_company_name_span">{{ $supplier->company_name
                                                    }}</span>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <b>@lang('lang.city'):</b> <span class="customer_city_span">{{
                                                    $supplier->city }}</span>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <b>@lang('lang.postal_code'):</b> <span
                                                    class="customer_postal_code_span">{{ $supplier->postal_code
                                                    }}</span>
                                            </div>
                                            <div class="col-md-12">
                                    ...
                                    <table class="table" id="supplier_service_table">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <th class="table_totals" style="text-align: right">@lang('lang.total')
                                                </th>
                                                <td></td>
                                                <td></td>
                                                <td></td>
