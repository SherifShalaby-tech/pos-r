        ...
        <div class="card-body" id="pci_accordian_div">
            ...
            <div class="accordion top_accordion" id="{{ @replace_space($class->name) }}">
                <div class="accordion-group pci_class_level level">
                    <div class="row">
                        <input id="product_class_selected{{ $class->id }}" name="pci[product_class_selected][]"
                            type="checkbox" value="{{ $class->id }}" @if (in_array($class->id, $product_class_selected))
                        checked @endif
                        ...
                        <div class="accordion-heading" style="width: 80%">
                            <a class="pci-accordion-toggle" data-toggle="collapse"
                                ...
                                <i class="fa fa-angle-right pci-angle-class-{{ @replace_space($class->name) }}"></i>
                                {{ $class->name }}

                            </a>
                        </div>
                    </div>
                    <div id="pci-collapse{{ @replace_space($class->name) }}" class="accordion-body collapse">
                        ...
                        <div class="accordion-inner">
                            ...
                            <div class="accordion"
                                ...
                                <div class="accordion-group  pci_category_level level">
                                    <div class="row">
                                        <input id="category_selected{{ $category->id }}" name="pci[category_selected][]"
                                            type="checkbox" @if (in_array($category->id, $category_selected)) checked
                                        @endif
                                        value="{{ $category->id }}"
                                        class="pci-my-new-checkbox">
                                        <div class="accordion-heading" style="width: 80%">
                                    ...
                                    <div id="pci-collapse{{ @replace_space($class->id . 'category_' . $category->name . '_' . $i) }}"
                                        ...
                                        <div class="accordion-inner">
                                            ...
                                            $brands = null;
                                            $brands = App\Models\Product::leftjoin('brands', 'products.brand_id',
                                            'brands.id')
                                            ...
                                            @php
                                            $products = App\Models\Product::leftjoin('variations', 'products.id',
                                            ...
                                            <div class="accordion"
                                                ...
                                                style="margin-left: 20px;">
                                                <div class="accordion-group  pci_sub_category_level level">
                                                    <div class="row">
                                                        <input id="sub_category_selected{{ $sub_category->id }}"
                                                            name="pci[sub_category_selected][]" type="checkbox"
                                                            value="{{ $sub_category->id }}" @if
                                                            (in_array($sub_category->id, $sub_category_selected))
                                                        checked @endif
                                                        class="pci-my-new-checkbox">
                                                        <div class="accordion-heading" style="width: 80%">
                                                            <a class="pci-accordion-toggle" data-toggle="collapse"
                        ...
                        <div class="accordion-inner">
                            ...
                            <div class="row product_row">
                                <div class="col-md-1">
                                    <input id="product_selected{{ $product->id }}" name="pci[product_selected][]"
                                        type="checkbox" value="{{ $product->id }}" @if (in_array($product->id,
