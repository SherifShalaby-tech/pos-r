...
<section class="forms pt-2">
    <div class="container-fluid">
        ...
        <x-page-title>
            <x-slot name="buttons">
                <a style="color: white" href="{{route('item-borrowed.create')}}" class="btn btn-primary"><i
            ...
            <table class="table dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td
                            style="color:#FFF !important; background-color: @if($deposit->status == 'Available') green !important; @elseif($deposit->status == 'Pending') yellow  @else red  @endif">
                            {{$deposit->status}}</td>
                        <td>{{$deposit->customer->name ?? '-'}}</td>
                        <td>
                            <a href="#" class="btn btn-primary" data-toggle="modal"
                                data-target="#EditProduct{{$deposit->id}}">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$deposit->deposit_amount}}" required="required"
                                                        type="number" name="deposit_amount" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                    ...
                    <div class="modal fade" id="EditProduct{{$deposit->id}}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$deposit->name}}" type="text" name="name"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
