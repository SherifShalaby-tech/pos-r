                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade @if (empty(request()->show)) show active @endif"
                                ...
                                @if ($balance < 0) <div class="col-md-12">
                                    <button
                                        data-href="{{ action('CustomerController@getPayContactDue', $customer->id) }}"
                            ...
                            <div class="col-md-12 text-muted">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="col-md-12 ">
                                            <b>@lang('lang.name'):</b> <span class="customer_name_span">{{
                                                $customer->name }}</span>
                                        </div>
                                ...
                                <table class="table dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>@if(!empty($payment->bank_deposit_date && ($payment->method ==
                                                'bank_transfer' || $payment->method ==
                                                'cheque'))){{@format_date($payment->bank_deposit_date)}} @endif</td>
                        ...
                        <div role="tabpanel" class="tab-pane fade @if (request()->show == 'sizes') show active @endif"
                            ...
                            <div class="col-md-12 mt-4 ml-2">
                                <a data-href="{{ action('CustomerSizeController@add', $customer->id) }}"
                                    ...
                                    data-container=".view_modal"><i class="fa fa-plus"></i>@lang('lang.add_size')</a>
                            </div>
                            @endcan
                            <div class="table-responsive">
                                <table class="table dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $customer_size->created_by_user ?
                                                $customer_size->created_by_user->name : '' }}
                                            </td>
