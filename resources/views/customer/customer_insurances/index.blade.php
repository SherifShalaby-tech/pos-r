                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{$deposit->penalties ?? ''}}" required="required"
                                                    type="text" name="penalties" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>{{trans('lang.the_amount_of_the_fine')}}</label>
                                                <input value="{{$deposit->penalty_amount ?? ''}}" required="required"
                                                    type="number" name="penalty_amount" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select required="required" class="form-control" name="item_id">
                                                    @foreach($products as $product)
                                                    <option {{$product->id == $deposit->product_id ? 'selected' : ''}}
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select required="required" class="form-control" name="customer_id">
                                                    @foreach($customers as $customer)
                                                    <option {{$customer->id == $deposit->customer_id ? 'selected' : ''}}
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input value="{{$deposit->deposit_amount}}" required="required"
                                                    type="number" name="insurance_amount" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>{{trans('lang.return_date')}}</label>
                                                <input value="{{$deposit->return_date}}" required="required" type="date"
                                                    name="return_date" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
