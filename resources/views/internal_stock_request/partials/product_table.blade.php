...
<tr>
    ...
    <td>@if($product->is_service){{0}}@else{{preg_match('/\.\d*[1-9]+/', (string)$product->current_stock) ? $product->current_stock : @num_format($product->current_stock)}}@endif <input type="hidden"
