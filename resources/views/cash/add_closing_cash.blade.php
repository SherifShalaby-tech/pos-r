<div class="modal-dialog add_closing_cash" role="document" style="max-width: 90%">
    <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::select('source_type', ['user' => __('lang.user'), 'safe' => __('lang.safe'), 'pos'
                            => __('lang.pos')], 'user', ['class' => 'selectpicker form-control',
                            'required','data-live-search' => 'true', 'style' => 'width: 80%', 'placeholder' =>
        ...
        <div class="modal-footer">
            <button type="submit" name="submit" class="btn btn-primary col-6 hide" value="adjustment"
            ...
            <button type="button"
                ...
                !='logout' ) data-dismiss="modal" @endif>@lang('lang.cancel')</button>
        </div>
