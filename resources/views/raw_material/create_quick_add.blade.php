<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('RawMaterialController@store'), 'id' => 'product-form-quick-add', 'method'
        =>
        'POST', 'class' => '', 'enctype' => 'multipart/form-data']) !!}

        <x-modal-header>
            <h4 class="modal-title">@lang('lang.add_new_raw_material')</h4>
...
<script type="text/javascript">
    ...
    $(".barcode_type").selectpicker("refresh");
