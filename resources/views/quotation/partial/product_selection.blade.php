    ...
    <div class="modal-dialog modal-lg" role="document" id="select_products_modal">
        <div class="modal-content">
            ...
            <div class="modal-body p-1">
                <x-collapse collapse-id="QuotationProductFilter" button-class="d-flex btn-secondary" group-class="mb-1"
                    body-class="py-1">
                    ...
                    <div class="col-md-12">
                        <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                            ...
                            <div class="col-md-3 mb-11px d-flex justify-content-center align-items-end">
                                <button type="button"
                                    class="btn btn-danger w-100 clear_filters{{$index}}">@lang('lang.clear_filters')</button>
                            </div>
                        </div>
                    </div>
                </x-collapse>
                                ...
                                <thead>
                                    <tr>
                                        <th>@lang('lang.select')<br>
                                            <input type="checkbox" name="product_select_all"
                                                class="product_select_all" />
                                        </th>
                                        <th>@lang('lang.image')</th>
                                        <th>@lang('lang.name')</th>
                                        <th>@lang('lang.product_code')</th>
                                        <th>@lang('lang.is_have_service')</th>
                                        ...
                                        @endcan
                                        <th>@lang('lang.selling_price_depends')</th>
                                        <th>@lang('lang.purchase_price_depends')</th>
