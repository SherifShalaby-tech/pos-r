                        ...
                        <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                            ...
                            <div class="col-md-3">
                                <label class="@if (app()->isLocale('ar')) mb-1 label-ar @else mb-1 label-en @endif"
                                    style="margin-top: 36px;">@lang('lang.customer_type'): <span
                ...
                <div class="row " style="display: none;">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="hidden" id="store_pos_id" name="store_pos_id" value="{{ $store_pos->id }}" />
                    ...
                    <div class="card-body py-2 px-4">
                        <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                            <div class="col-md-3 d-flex justify-content-center align-items-center">
                                <div class=" toggle-pill-color d-flex flex-column align-items-center">
                                    <input id="block_qty" name="block_qty" type="checkbox" value="1"
                                        class="form-control-custom">
                                    <label for="block_qty"></label>
                                    <span>
                                        <strong>@lang('lang.block_qty')</strong>
                                    </span>
                                </div>
                            </div>
                            <div class="col-md-3">
