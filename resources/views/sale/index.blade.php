...
<section class="forms pos-section no-print">
    <div class="container-fluid px-2">
        ...
        <x-page-title>
            ...
            <h4 class="print-title-hint" style="display:none;">sale_report</h4>
                ...
                <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            __('lang.category') : __('lang.product_class') . ':', ['class' =>
                            app()->isLocale('ar') ? 'mb-1 label-ar' : 'mb-1 label-en'
                            ]) !!}
                            {!! Form::select('product_class_id[]', $product_classes,
                            request()->product_class_id, ['class' => 'form-control sale_filter
                            selectpicker',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            ['class' => 'form-control sale_filter selectpicker', 'data-live-search' =>
                            'true',
                            'data-actions-box' => 'true', 'placeholder' => __('lang.all'), 'multiple', 'id'
                            =>
                            'sub_category_id']) !!}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('deliveryman_id', __('lang.deliveryman'), ['class' =>
                            app()->isLocale('ar') ? 'mb-1 label-ar' : 'mb-1 label-en'
                            ]) !!}
                            {!! Form::select('deliveryman_id',['all_delivery' => 'All Delivery'] +
                            $delivery_men, request()->deliveryman_id, ['class' => 'form-control
                            sale_filter',
                    ...
                    <div class="col-md-2 d-flex justify-content-center align-items-end mb-11px">
                        <button type="submit" class="btn btn-primary w-100"
                            id="submit-filter">@lang('lang.filter')</button>
                    </div>
                    <div class="col-md-2 d-flex justify-content-center align-items-end mb-11px">
                        <button type="button"
