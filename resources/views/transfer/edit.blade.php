                                ...
                                <table class="table table-bordered table-striped table-condensed" id="product_table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @endphp
                                            <td>
                                                <input type="text" class="form-control quantity" min=1 max="{{$qty_available ? preg_match('/\.\d*[1-9]+/', (string)$qty_available->qty_available) ? $qty_available->qty_available : @num_format($qty_available->qty_available) : preg_match('/\.\d*[1-9]+/', (string)$product->quantity) ? $product->quantity : @num_format($product->quantity)}}"
