                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="date_of_start_working">@lang('lang.date_of_start_working'):
                                        </label>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <div class="" style="margin-top: 20px">
                                        ...
                                        <label for="fixed_wage"><strong>@lang('lang.fixed_wage')</strong></label>
                                        <br>
                                        <label for="">@lang('lang.fixed_wage_value') :</label>
                                        {{!empty($employee->fixed_wage_value) ?
                                        @num_format($employee->fixed_wage_value) : null}} <br>
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <div class="" style="margin-top: 20px">
                                        <label for="commission"><strong>@lang('lang.commission_%'):
                                            </strong></label>
                                        {{!empty($employee->commission_value) ?
                                        @num_format($employee->commission_value) : null}}
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                $employee->check_out[$key] : null, ['class' => 'form-control
                                                input-md
                                                ', 'readonly']) !!}
                                            </td>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <div>
                                            <tr=class="module_permission" data-moudle="{{$key_module}}">
                                                ...
                                                @php
                                                $sub_module_permission_array =
                                                $subModulePermissionArray[$key_module];
                                                @endphp
                                                ...
                                                <tr class="sub_module_permission_{{$key_module}}">
                                                    ...
                                                    <td class="">
                                                        ...
                                                        !empty($user)
                                                        &&
                                                        !empty($user->hasPermissionTo($view_permission)) ? true :
                                                        false,
